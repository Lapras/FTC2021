...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(5, 0.01, 0.01);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(20, 0.01, 0.01);
